...
@Entity
@Table(name = "portfolio_transaction", uniqueConstraints = @UniqueConstraint(
        name = "uk_portfolio_transaction_user_provider_fingerprint",
        columnNames = {"user_id", "provider_type", "record_fingerprint"}
))
@Getter
@Setter
public class PortfolioTransactionEntity extends AbstractEntity {
    @Id
