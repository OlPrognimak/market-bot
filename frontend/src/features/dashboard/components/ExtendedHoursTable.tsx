...
import type { ExtendedHoursResult } from "../types/market-dashboard";

export function ExtendedHoursTable({ results }: { results: ExtendedHoursResult[] }) {
...
function sessionLabel(session: ExtendedHoursResult["session"]) {
